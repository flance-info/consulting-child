                ...
                if( $stm_event_date_start = get_post_meta( get_the_ID(), 'stm_event_date_start', true ) ) : ?>
                    <li>
                        <div class="event__calendar">
                            <i class="fa fa-calendar" aria-hidden="true"></i> <?php echo date_i18n( $date_format, $stm_event_date_start ); ?>
                        </div>
                    </li>
                <?php endif; ?>
                        ...
                        <li>
                            <div class="event__time"><i class="fa fa-clock-o"></i>
                                ...
                                if( $stm_event_time_start != '' && $stm_event_time_end != '' ) {
                                    echo date_i18n( $time_format, strtotime($stm_event_time_start) ) . ' ' . esc_html__('to', 'consulting') . ' ' . date_i18n( $time_format, strtotime($stm_event_time_end) );
                                } elseif( $stm_event_time_start == '' ) {
                                    echo date_i18n( $time_format, strtotime($stm_event_time_end) );
                                } elseif( $stm_event_time_end == '' ) {
                                    echo date_i18n( $time_format, strtotime($stm_event_time_start) );
                                }
                                ?>
                            </div>
                        </li>
