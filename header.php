...
.vc_btn3.vc_btn3-color-juicy-pink, .vc_btn3.vc_btn3-color-juicy-pink.vc_btn3-style-flat, .vc_btn3.vc_btn3-color-juicy-pink:hover {
    color: #fff;
    background-color: #778e1d;
}	
...
@media only screen and (max-width: 799px) {
	.consulting-custom-title, .consulting-custom-title b
	{font-size:12px !important;}
	
.comment-body .comment-text p, .wpb_text_column p img {
    width: 100%;
	height:200px;
}
}	
                            ...
                            <div class="container">
                                <?php if (consulting_get_header_style() == 'header_style_6') : ?>
                                    ...
                                    <ul class="top_bar_contacts">
                                        ...
                                        $top_bar_contact_phone = get_theme_mod('top_bar_contact_phone', __("For Inquiry : INT'L : (949) 481-2396    U.S: 1 (800)-515-0335", 'consulting'));
                        ...
                        <div class="header_top clearfix">
                            <div class="container">
                                ...
                                <?php if (consulting_get_header_style() == 'header_style_4' and ($consulting_config['layout'] == 'layout_13' || $consulting_config['layout'] == 'layout_barcelona')): ?>
                                    ...
                                    <?php endif; ?>
                                    <?php if (consulting_get_header_style() == 'header_style_4' && $header_phone = get_theme_mod('header_phone', __('<strong>INT : (949) 481-2396    U.S: 1 (800)-515-0335</strong><span data-scroll-to="request-call-back>Request call back</span>>Request call back</span>', 'consulting'))): ?>
